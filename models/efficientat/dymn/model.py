...
from models.efficientat.dymn.dy_block import DynamicInvertedResidualConfig, DY_Block, DynamicConv, DyReLUB
from models.efficientat.mn.block_types import InvertedResidualConfig, InvertedResidual
...
class DyMN(nn.Module):
    ...
    def _forward_impl(self, x: Tensor) -> (Tensor, Tensor):
        temp_features = self._feature_forward(x)
        x, embed = self._clf_forward(temp_features)
        return x, embed, temp_features
